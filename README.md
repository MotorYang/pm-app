# ProManager - 技术架构与开发文档

ProManager 是一款基于 **Tauri 2.0** 和 **Vue 3** 构建的高性能、本地优先的项目管理应用程序。本项目旨在提供一个轻量级、安全且功能丰富的桌面环境，用于管理本地代码项目、文档、Git 版本控制以及加密敏感数据。
